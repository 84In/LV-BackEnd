...
public class MailService {
    ...
    public void handle(SendCancelledOrderMailCommand command) {
        ...
        context.setVariable("username", user.getUsername());
        context.setVariable("delivery", order.getDelivery());
        String createdAtFormattedDate = order.getCreatedAt() != null
                ? order.getCreatedAt().format(DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm:ss"))
                : LocalDateTime.now().format(DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm:ss"));
        String cancelledAtFormattedDate = order.getCreatedAt() != null
                ? order.getUpdatedAt().format(DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm:ss"))
                : LocalDateTime.now().format(DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm:ss"));
        context.setVariable("createdAt", createdAtFormattedDate);
        context.setVariable("cancelledAt", cancelledAtFormattedDate);
        context.setVariable("reason", command.getReason());
        context.setVariable("orderId", order.getId());
        context.setVariable("orderDetails", order.getOrderDetails());
        context.setVariable("totalPrice", order.getTotalPrice());
